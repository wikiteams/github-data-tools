...
if __name__ == "__main__":
    ...
    if resume == 'TeamAdds' or resume is None:
        ...
        team_adds_df.to_csv(ultimate_save_path + 'normalized_' + team_adds_csv_filename, mode='wb', sep=';', encoding='UTF-8')
    ...
    if resume == 'MemberAdds' or resume is None:
        ...
        print member_adds_df.tail(20)
        print colored('Writing normalized CSV..', 'blue')
        member_adds_df.to_csv(ultimate_save_path + 'normalized_' + member_adds_csv_filename, mode='wb', sep=';', encoding='UTF-8')
    ...
    if resume == 'Created' or resume is None:
        ...
        print created_df.tail(20)
        print colored('Writing normalized CSV..', 'blue')
        created_df.to_csv(ultimate_save_path + 'normalized_' + created_at_filename, mode='wb', sep=';', encoding='UTF-8')
        ...
        member_adds_df.to_csv(ultimate_save_path + 'normalized_cr_' + member_adds_csv_filename, mode='wb', sep=';', encoding='UTF-8')
    ...
    if resume == 'Pulls' or resume is None:
        ...
        print pulls_df.tail(20)
        print colored('Writing normalized CSV..', 'blue')
        pulls_df.to_csv(ultimate_save_path + 'normalized_' + pulls_csv_filename, mode='wb', sep=';', encoding='UTF-8')
        ...
        print colored('Writing normalized CSV 2..', 'blue')
        pulls_df.to_csv(ultimate_save_path + 'normalized_cr_' + pulls_csv_filename, mode='wb', sep=';', encoding='UTF-8')
    ...
    if resume == 'Follows' or resume is None:
        ...
        print follows_df.tail(20)
        print colored('Writing normalized CSV..', 'blue')
        follows_df.to_csv(ultimate_save_path + 'normalized_' + follows_csv_filename, mode='wb', sep=';', encoding='UTF-8')
    ...
    if resume == 'Issues' or resume is None:
        ...
        print issues_df.tail(20)
        print colored('Writing normalized CSV..', 'blue')
        issues_df.to_csv(ultimate_save_path + 'normalized_' + issues_csv_filename, mode='wb', sep=';', encoding='UTF-8')
        ...
        print colored('Writing normalized CSV 2..', 'blue')
        issues_df.to_csv(ultimate_save_path + 'normalized_cr_' + issues_csv_filename, mode='wb', sep=';', encoding='UTF-8')
